...
public class Test_PostUserID {
	...
	public Response respond(String input, @QueryParam("userEmail")  String email,
										  ...
										  @QueryParam("FirebaseToken") String FirebaseToken) throws Exception {
		...
		if(!reply.equals("bad"))
		{
			...
			document.put("submittedCampaign", new ArrayList());
			document.put("FirebaseToken", FirebaseToken);
